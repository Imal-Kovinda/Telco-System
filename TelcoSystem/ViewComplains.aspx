<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewComplains.aspx.cs" Inherits="TelcoSystem.ViewComplains" %>
					...
					<div class="form-row">
                        ...
                        <div class="col-md-12 mb-3">
                         ...
                         <div class="col-md-12 mb-3">
							...
							<input type="text" class="form-control" id="informed_by"  aria-describedby="inputGroupPrepend3" >
				...
				<%--<form runat="server">--%>
					<div class="form-row">
                         ...
                         <div class="d-flex flex-row-reverse">
                             <asp:Button runat="server"  class="mr-2 btn btn-success" onclick="backToDashboard" Text="OK" />
                        </div>
