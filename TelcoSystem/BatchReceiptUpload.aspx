<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatchReceiptUpload.aspx.cs" Inherits="TelcoSystem.BatchReceiptUpload" %>
...
<div class="row">
	<div class="col-12">
			...
			<div class="card-body" style="padding-top:0rem;margin-top:10px;">
                ...
                <div class="dropdown" style="display:flex;gap:20px; margin-top:-12px;margin-bottom:20px;">
                    ...
                    <select class="form-control" style="width:25%; margin-bottom:10px;" id="exampleFormControlSelect12">
                     ...
                     <div class="form-group" style="display:flex;gap:20px;">
						<label style="font-size:17px;color:deeppink;" for="dupl">DUPL</label>
            ...
            <div class="btn" style="display:flex; margin-left:30px; margin-top:-41px;">
                <button type="button" class="btn btn-primary" style="width:100px; height50px;">Save</button>
