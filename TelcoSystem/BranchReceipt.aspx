	            ...
	            <div class="modal-dialog" role="document">
		            <div class="modal-content">
			            <div class="modal-header">
				            <h5 class="modal-title" id="exampleModalFormTitle">Credit Card Payments</h5>
			            ...
			            <div class="modal-body">
				            <form>
					            <div class="form-group">
						            <label for="exampleFormControlInput1">Card Type</label>
						            <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Credit_card_type">
					
					            </div>

					            <div class="form-group">
						            <label for="exampleFormControlPassword">Bnk Name</label>
						            <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="Bank_Name">
					            </div>

                                <div class="form-group">
						            <label for="exampleFormControlPassword">Card Number</label>
						            <input type="number" class="form-control" id="exampleFormControlInput3" placeholder="Card_Number">
					            </div>
					             ...
					             <div class="form-group">
						            ...
						            <input type="text" class="form-control" id="exampleFormControlInput4" placeholder="Cheque_date">
					            </div>
